...
public class AboutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myIntent = AboutActivity.this.getIntent();
        ...
        AboutActivity.this.setSupportActionBar(hamacToolBar);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        Intent myIntent = nav.getIntentfromSelectedActivity(AboutActivity.this, item.getItemId(), firstLaunch_flag);
