...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myIntent = SettingsActivity.this.getIntent();
...
//        HamacList = (List<Hamac>) myIntent.getSerializableExtra("HAMAC_LIST");
        ...
        SettingsActivity.this.setSupportActionBar(hamacToolBar);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        Intent myIntent = nav.getIntentfromSelectedActivity(SettingsActivity.this, item.getItemId(), firstLaunch_flag);
